            ...
            <div className="bg-white p-8 rounded-xl shadow-[0_4px_20px_rgba(0,0,0,0.05)] border border-stone-200 w-full max-w-md text-center">
                ...
                <div className="space-y-4">
                    <button
                        ...
                        disabled={loading}
                        className="w-full flex items-center justify-center gap-3 bg-white border border-stone-300 hover:bg-gray-50 text-stone-700 font-bold py-3 px-4 rounded-lg transition-all shadow-sm"
                    >
                        {loading ? (
                    ...
                    <form onSubmit={handleEmailAuth} className="space-y-3 text-left">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className="w-full border-gray-300 rounded-lg text-sm px-3 py-2 focus:ring-2 focus:ring-[#1a3c34] focus:border-transparent outline-none"
