...
export default function ReportEditor() {
    ...
    return (
        <div className="fixed inset-0 overflow-y-auto overscroll-y-contain md:static md:h-screen md:overflow-hidden flex flex-col items-stretch md:items-center py-2 sm:py-8 font-sans print:py-0 print:block print:static print:min-h-0 print:h-auto print:bg-white bg-gray-100">
