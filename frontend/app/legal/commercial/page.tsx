...
const content = {
  en: {
    ...
    rows: [
      ...
      ['Price', 'Plan-based monthly pricing. Current public pricing guidance is Standard JPY 5,980 per month, Pro JPY 14,800 per month, and Premium JPY 34,800 per month. Final trial and billing conditions are presented at checkout.'],
  ...
  ja: {
    ...
    rows: [
      ...
      ['販売価格', 'プラン別の月額料金です。現時点の公開想定価格は Standard 月額5,980円、Pro 月額14,800円、Premium 月額34,800円です。無料トライアルの有無や最終的な請求条件は申込画面で案内します。'],
