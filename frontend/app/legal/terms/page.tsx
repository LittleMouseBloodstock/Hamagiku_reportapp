...
const content = {
  ...
  ja: {
    ...
    sections: [
      ...
      ['サブスクリプション', 'Shinba Report はプラン別の月額サブスクリプションとして提供されます。公開時点の想定価格は Standard 月額5,980円、Pro 月額14,800円、Premium 月額34,800円です。無料トライアルの有無や最終的な請求条件は申込画面で案内します。トライアル終了後も利用を継続した場合、解約まで継続課金に同意したものとみなされます。'],
