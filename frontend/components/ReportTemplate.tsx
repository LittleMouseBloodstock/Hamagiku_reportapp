...
export default function ReportTemplate({ initialData, onDataChange, readOnly = false, batchPrint = false }: ReportTemplateProps) {
    ...
    const showLogoPrimaryFontSize = primaryNameLength > 18 ? '1.55rem' : primaryNameLength > 15 ? '1.72rem' : primaryNameLength > 12 ? '1.95rem' : '2.25rem';
    ...
    const rootClassName = batchPrint
        ? 'bg-white font-sans'
        : 'flex w-full flex-col bg-gray-100 font-sans overflow-visible md:min-h-0 md:h-full md:flex-row md:overflow-hidden';
                ...
                >
                    ...
                    <div className="relative z-10 flex flex-col h-full min-h-0">
                        ...
                        <div className={`flex justify-between items-end gap-4 ${showLogo ? 'mb-5' : 'mb-4'}`}>
                            <div className={`min-w-0 ${showLogo ? 'flex-[0.95]' : 'flex-1'}`}>
                            ...
                            <div
                                className={`sire-dam-line bg-[#f4f7f6] py-2 px-4 border-l-[3px] border-[#1a3c34] ${showLogo ? 'w-[54%]' : 'min-h-[50px] flex items-center'} ${lang === 'ja' ? 'text-[15px] text-[#666]' : 'w-[52%] text-[14px] leading-[1.4] text-[#666]'}`}
